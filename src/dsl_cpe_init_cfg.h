...
#define DSL_CPE_FW_SET(pFw1, szFw1, nFwFs, pFw2, szFw2) pFw1, szFw1, nFwFs, pFw2, szFw2
...
#define DSL_CPE_LL_CFG_SET(HYBRID) {HYBRID}
#endif /* #if defined(INCLUDE_DSL_CPE_API_DANUBE)*/

#if defined(INCLUDE_DSL_CPE_API_VRX)
#define DSL_CPE_LL_CFG_SET(FILTER, \
   HS_TONE_GROUP_MODE, \
   HS_TONE_GROUP_A, HS_TONE_GROUP_V, HS_TONE_GROUP_AV, \
   BASEADDR, IRQNUM, VIRTUAL_NOISE_ENABLE_US, VIRTUAL_NOISE_ENABLE_DS, NTR_ENABLE) \
   {FILTER, \
   HS_TONE_GROUP_MODE, \
   HS_TONE_GROUP_A, HS_TONE_GROUP_V, HS_TONE_GROUP_AV, \
   BASEADDR, IRQNUM, VIRTUAL_NOISE_ENABLE_US, VIRTUAL_NOISE_ENABLE_DS, NTR_ENABLE}
